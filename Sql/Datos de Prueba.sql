...
-- =====================================================
-- Comenta estas l�neas si NO quieres eliminar datos existentes
...
INSERT INTO Aceite (Viscosidad, TipoAceite, Uso, EsAgrenel, IdPresentacion, IdProducto)
VALUES ('15W-40', 'Sint�tico', 'Diesel', 0, 1, SCOPE_IDENTITY());
...
SELECT 'Categor�as' as Tabla, COUNT(*) as Cantidad FROM Categoria;
